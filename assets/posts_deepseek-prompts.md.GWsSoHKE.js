import{_ as s,c as n,o as e,ag as p}from"./chunks/framework.DFDZKXxq.js";const u=JSON.parse('{"title":"DeepSeek 提示词使用指南","description":"","frontmatter":{},"headers":[],"relativePath":"posts/deepseek-prompts.md","filePath":"posts/deepseek-prompts.md"}'),l={name:"posts/deepseek-prompts.md"};function i(t,a,o,c,h,d){return e(),n("div",null,a[0]||(a[0]=[p(`<h1 id="deepseek-提示词使用指南" tabindex="-1">DeepSeek 提示词使用指南 <a class="header-anchor" href="#deepseek-提示词使用指南" aria-label="Permalink to &quot;DeepSeek 提示词使用指南&quot;">​</a></h1><p>DeepSeek 是一个强大的开源大语言模型，要充分发挥它的能力，合适的提示词（Prompt）设计至关重要。本文将分享一些实用的提示词技巧。</p><h2 id="基础提示词模式" tabindex="-1">基础提示词模式 <a class="header-anchor" href="#基础提示词模式" aria-label="Permalink to &quot;基础提示词模式&quot;">​</a></h2><h3 id="_1-角色设定" tabindex="-1">1. 角色设定 <a class="header-anchor" href="#_1-角色设定" aria-label="Permalink to &quot;1. 角色设定&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>你是一位专业的[职业]，请帮我[具体任务]。</span></span></code></pre></div><p>这种模式可以让模型更好地理解上下文，提供更专业的回答。例如：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>你是一位资深的前端工程师，请帮我优化这段 React 代码。</span></span></code></pre></div><h3 id="_2-任务描述" tabindex="-1">2. 任务描述 <a class="header-anchor" href="#_2-任务描述" aria-label="Permalink to &quot;2. 任务描述&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>请帮我完成以下任务：</span></span>
